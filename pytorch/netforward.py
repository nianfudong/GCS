...
parser.add_argument('--resume', default='F:/wflw/modelv1/modelgcs/v18/lightCNN_5991_checkpoint.pth.tar', type=str, metavar='PATH',
...
inFile = open('F:/wflw/WFLW_annotations/testGroundtruth.txt','r')
outResults = open('F:/wflw/modelv1/results/modelgcs/gcswingpredTest_1.5.txt','w')
srcImgRoot = 'F:/wflw/cropWFLWImgsTest/'
...
def main():
    ...
    allImgFiles = inFile.readlines()
    for line in allImgFiles:
        imgName = line.split(' ')[0]
        print(imgName)
        imgFile = srcImgRoot + imgName
